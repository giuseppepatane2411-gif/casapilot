...
const benefits = [
  ["Richieste compatibili", "Pilot filtra prima i requisiti indispensabili e ti mostra le opportunità coerenti con servizi, zona e disponibilità."],
  ["Preventivi più chiari", "Prepara offerte strutturate, confrontabili e facili da comprendere per il proprietario."],
  ["Contatti protetti", "La prima conversazione resta dentro CasaPilot e i recapiti si sbloccano soltanto dopo l’accettazione."],
    ...
    <main className="min-h-screen bg-white text-slate-950">
      <section className="border-b border-slate-100 bg-gradient-to-b from-blue-50/80 to-white">
        <div className="mx-auto max-w-6xl px-5 py-16 text-center sm:px-8 lg:py-24">
          <span className="inline-flex rounded-full border border-blue-200 bg-white px-4 py-2 text-sm font-semibold text-blue-700 shadow-sm">CasaPilot per professionisti</span>
          ...
          <p className="mx-auto mt-6 max-w-3xl text-lg leading-8 text-slate-600">Registra la tua attività, configura i servizi che offri e lascia che Pilot selezioni le richieste più adatte. Meno contatti casuali, più tempo per il lavoro che sai fare bene.</p>
          <div className="mt-9 flex flex-col justify-center gap-3 sm:flex-row">
            ...
            <Link href="/professionista" className="inline-flex min-h-12 items-center justify-center rounded-xl border border-slate-200 bg-white px-7 py-3 font-semibold text-slate-700 shadow-sm hover:border-blue-200 hover:text-blue-700">Accedi a CasaPilot Pro</Link>
          </div>
        ...
        <div className="mx-auto max-w-6xl px-5 py-14 sm:px-8 lg:py-20">
          <div className="grid gap-8 lg:grid-cols-[0.8fr_1.2fr] lg:items-center">
            <div>
              ...
              <p className="mt-4 leading-7 text-slate-600">CasaPilot non ti chiede se sei “privato o professionista” dentro il percorso professionale. Scegli soltanto come è organizzata la tua attività.</p>
            </div>
      ...
      <section className="mx-auto max-w-5xl px-5 py-14 text-center sm:px-8 lg:py-20">
        <div className="rounded-[2rem] bg-slate-950 px-6 py-12 text-white sm:px-10">
          ...
          <p className="mx-auto mt-4 max-w-2xl leading-7 text-slate-300">Configura ciò che fai, dove lavori e quanta capacità hai. Pilot userà queste informazioni per evitare opportunità inutili.</p>
