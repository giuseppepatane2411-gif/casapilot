...
const DEMO: AgencyListing[] = [
  {
    ...
    slug: "attico-terrazza-bologna-saragozza",
    operation: "sale",
    property_type: "Attico",
    title: "Attico luminoso con terrazza sui colli",
    description: "Una scheda dimostrativa della nuova vetrina immobiliare Guimmia.",
    price_cents: 54500000,
    rent_period: null,
    city: "Bologna",
    province: "BO",
    zone: "Saragozza",
  ...
  },
  {
    ...
    slug: "bilocale-bolognina-bologna",
    operation: "rent",
    property_type: "Appartamento",
    title: "Bilocale arredato nel cuore della Bolognina",
  ...
  },
  {
    ...
    slug: "casa-vacanze-bologna-centro",
    operation: "rent",
    property_type: "Casa vacanze",
    title: "Dimora di charme per soggiorni nel centro storico",
    description:
