...
function getDefinitions(operation: OperationType): PhaseDefinition[] {
  ...
  return [
    ...
    },
    {
      id: "documents",
      label: "Documenti e verifiche",
      description: "Fascicolo, riferimenti catastali e verifiche per impostare una locazione più sicura.",
      weight: weights.documents,
    },
    {
      id: "preparation",
      label: "Canone, contratto e annuncio",
      description: "Strategia di locazione, canone, criteri e presentazione.",
      weight: weights.preparation,
    },
    {
      id: "market",
      label: "Pubblicazione e selezione",
      description: "Richieste, visite e prima valutazione dei candidati.",
      weight: weights.market,
    },
    {
      id: "closing",
      label: "Inquilino, contratto e consegna",
  ...
  return {
    ...
    title:
      journey.operation === "sale"
        ...
        : "Percorso verso l’affitto",
    objectiveLabel: journey.operation === "sale" ? "Vendere" : "Affittare",
    currentPhaseId,
